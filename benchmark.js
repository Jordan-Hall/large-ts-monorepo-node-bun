...
const bigComparisonTable = [
  ...
  {
    Category: `${affected50Info.count} Affected (~${affected50Info.percentage}%)`,
    "Node None-Batch": benchmarkTimes.node.normal.affected50,
    "Node Batch": benchmarkTimes.node.batch.affected50,
    "Bun None-Batch": benchmarkTimes.bun.normal.affected50,
    "Bun Batch": benchmarkTimes.bun.batch.affected50,
    ...calculateWinnerAndPercentForAll(
      benchmarkTimes.node.normal.affected50,
      benchmarkTimes.node.batch.affected50,
      benchmarkTimes.bun.normal.affected50,
  ...
  {
    Category: `leaf dependency affected with @nx/js:tsc`,
    "Node None-Batch": benchmarkTimes.node.normal.affectedLeafDep,
    "Node Batch": benchmarkTimes.node.batch.affectedLeafDep,
    "Bun None-Batch": benchmarkTimes.bun.normal.affectedLeafDep,
    "Bun Batch": benchmarkTimes.bun.batch.affectedLeafDep,
    ...calculateWinnerAndPercentForAll(
      benchmarkTimes.node.normal.affectedLeafDep,
      benchmarkTimes.node.batch.affectedLeafDep,
      benchmarkTimes.bun.normal.affectedLeafDep,
